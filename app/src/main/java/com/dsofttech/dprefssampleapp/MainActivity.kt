...
import com.dsofttech.dprefssampleapp.data.SampleObject
import com.dsofttech.dprefssampleapp.databinding.ActivityMainBinding
import com.dsofttech.dprefssampleapp.utils.Utils.getSampleObject
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnReadObject.setOnClickListener {
            val retrievedData = DPrefs.getObject("PREFS_OBJECT", SampleObject::class.java)
